 ...
 */
@Slf4j
public class DefaultDynamicRouteServiceImpl extends DynamicRouteServiceImpl {

    private RouteDefinitionRepository routeDefinitionWriter;

    public DefaultDynamicRouteServiceImpl(RouteDefinitionRepository routeDefinitionWriter) {
